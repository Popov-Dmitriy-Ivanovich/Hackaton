...
class UsersTable(BaseTable):
    ...
    rel_to_login_data_table = relationship(
        "LoginDataTable", back_populates="fk_to_users_table"
    )
    rel_to_favourites_table = relationship(
        "FavouritesTable", back_populates="fk_fav_to_users_table"
    )
...
class LoginDataTable(BaseTable):
    ...
    fk_to_users_table = relationship(
        "UsersTable", back_populates="rel_to_login_data_table"
    )
...
class CoursesTable(BaseTable):
    ...
    fk_to_professions_table = relationship(
        "ProfessionsTable", back_populates="rel_to_courses_table"
    )
...
class ProfessionsTable(BaseTable):
    ...
    description = Column(String)
    rel_to_courses_table = relationship(
        "CoursesTable", back_populates="fk_to_professions_table"
    )
...
class FavouritesTable(BaseTable):
    ...
    fk_fav_to_users_table = relationship(
        "UsersTable", back_populates="rel_to_favourites_table"
    )
